...
<?php
	...
	$sql = "select MaBaiViet, TieuDe , date_format(NgayDang,'%d/%m') as Ngay, MaChuDe from  tbl_noidungdiadiem " .
        " where MaChuDe='" . $dong['MaChuDe'] .
        "' and NgayDang < (select NgayDang from  tbl_noidungdiadiem where MaBaiViet=" . $dong["MaBaiViet"] . ") order by MaBaiViet desc";
